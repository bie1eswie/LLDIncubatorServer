...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Compiler_21", {
        get: function () {
            if ((this.__Compiler_21 == null)) {
                (this.__Compiler_21 = new import16.Compiler());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_22", {
        get: function () {
            if ((this.__APP_ID_22 == null)) {
                (this.__APP_ID_22 = import41._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_HAMMER_GESTURE_CONFIG_24", {
        get: function () {
            if ((this.__HAMMER_GESTURE_CONFIG_24 == null)) {
                (this.__HAMMER_GESTURE_CONFIG_24 = new import17.HammerGestureConfig());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_26", {
        get: function () {
            if ((this.__EventManager_26 == null)) {
                (this.__EventManager_26 = new import18.EventManager(this._EVENT_MANAGER_PLUGINS_25, this.parent.get(import44.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DomRootRenderer_29", {
        get: function () {
            if ((this.__DomRootRenderer_29 == null)) {
                (this.__DomRootRenderer_29 = new import20.DomRootRenderer_(this._DOCUMENT_23, this._EventManager_26, this._DomSharedStylesHost_27, this._AnimationDriver_28, this._APP_ID_22));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgProbeToken_30", {
        get: function () {
            if ((this.__NgProbeToken_30 == null)) {
                (this.__NgProbeToken_30 = [import5.routerNgProbeToken()]);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_31", {
        get: function () {
            if ((this.__RootRenderer_31 == null)) {
                (this.__RootRenderer_31 = import45._createConditionalRootRenderer(this._DomRootRenderer_29, this.parent.get(import45.NgProbeToken, null), this._NgProbeToken_30));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DomSanitizer_32", {
        get: function () {
            if ((this.__DomSanitizer_32 == null)) {
                (this.__DomSanitizer_32 = new import21.DomSanitizerImpl());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AnimationQueue_34", {
        get: function () {
            if ((this.__AnimationQueue_34 == null)) {
                (this.__AnimationQueue_34 = new import22.AnimationQueue(this.parent.get(import44.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ViewUtils_35", {
        get: function () {
            if ((this.__ViewUtils_35 == null)) {
                (this.__ViewUtils_35 = new import23.ViewUtils(this._RootRenderer_31, this._Sanitizer_33, this._AnimationQueue_34));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Title_39", {
        get: function () {
            if ((this.__Title_39 == null)) {
                (this.__Title_39 = new import24.Title());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RadioControlRegistry_40", {
        get: function () {
            if ((this.__RadioControlRegistry_40 == null)) {
                (this.__RadioControlRegistry_40 = new import25.RadioControlRegistry());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_BrowserXhr_41", {
        get: function () {
            if ((this.__BrowserXhr_41 == null)) {
                (this.__BrowserXhr_41 = new import26.BrowserXhr());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ResponseOptions_42", {
        get: function () {
            if ((this.__ResponseOptions_42 == null)) {
                (this.__ResponseOptions_42 = new import27.BaseResponseOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_XSRFStrategy_43", {
        get: function () {
            if ((this.__XSRFStrategy_43 == null)) {
                (this.__XSRFStrategy_43 = import10._createDefaultCookieXSRFStrategy());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_XHRBackend_44", {
        get: function () {
            if ((this.__XHRBackend_44 == null)) {
                (this.__XHRBackend_44 = new import28.XHRBackend(this._BrowserXhr_41, this._ResponseOptions_42, this._XSRFStrategy_43));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RequestOptions_45", {
        get: function () {
            if ((this.__RequestOptions_45 == null)) {
                (this.__RequestOptions_45 = new import29.BaseRequestOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Http_46", {
        get: function () {
            if ((this.__Http_46 == null)) {
                (this.__Http_46 = import10.httpFactory(this._XHRBackend_44, this._RequestOptions_45));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_49", {
        get: function () {
            if ((this.__LocationStrategy_49 == null)) {
                (this.__LocationStrategy_49 = import5.provideLocationStrategy(this.parent.get(import47.PlatformLocation), this.parent.get(import48.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_48));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Location_50", {
        get: function () {
            if ((this.__Location_50 == null)) {
                (this.__Location_50 = new import30.Location(this._LocationStrategy_49));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_UrlSerializer_51", {
        get: function () {
            if ((this.__UrlSerializer_51 == null)) {
                (this.__UrlSerializer_51 = new import31.DefaultUrlSerializer());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RouterOutletMap_52", {
        get: function () {
            if ((this.__RouterOutletMap_52 == null)) {
                (this.__RouterOutletMap_52 = new import32.RouterOutletMap());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgModuleFactoryLoader_53", {
        get: function () {
            if ((this.__NgModuleFactoryLoader_53 == null)) {
                (this.__NgModuleFactoryLoader_53 = new import33.SystemJsNgModuleLoader(this._Compiler_21, this.parent.get(import33.SystemJsNgModuleLoaderConfig, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_54", {
        get: function () {
            if ((this.__Router_54 == null)) {
                (this.__Router_54 = import5.setupRouter(this._ApplicationRef_20, this._UrlSerializer_51, this._RouterOutletMap_52, this._Location_50, this, this._NgModuleFactoryLoader_53, this._Compiler_21, this._ROUTES_47, this._ROUTER_CONFIGURATION_48, this.parent.get(import49.UrlHandlingStrategy, null), this.parent.get(import50.RouteReuseStrategy, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ActivatedRoute_55", {
        get: function () {
            if ((this.__ActivatedRoute_55 == null)) {
                (this.__ActivatedRoute_55 = import5.rootRoute(this._Router_54));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadAllModules_59", {
        get: function () {
            if ((this.__PreloadAllModules_59 == null)) {
                (this.__PreloadAllModules_59 = new import34.PreloadAllModules());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_60", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_60 == null)) {
                (this.__ROUTER_INITIALIZER_60 = import5.getBootstrapListener(this._RouterInitializer_15));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Configuration_62", {
        get: function () {
            if ((this.__Configuration_62 == null)) {
                (this.__Configuration_62 = new import35.Configuration());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ThingService_63", {
        get: function () {
            if ((this.__ThingService_63 == null)) {
                (this.__ThingService_63 = new import36.ThingService(this._Http_46, this._Configuration_62));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__19 = new import15.ApplicationRef_(this.parent.get(import44.NgZone), this.parent.get(import52.Console), this, this._ErrorHandler_14, this, this._ApplicationInitStatus_17, this.parent.get(import14.TestabilityRegistry, null), this._Testability_18);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import5.RouterInitializer)) {
            return this._RouterInitializer_15;
        }
        ...
        if ((token === import35.Configuration)) {
            return this._Configuration_62;
        }
        if ((token === import36.ThingService)) {
            return this._ThingService_63;
        }
