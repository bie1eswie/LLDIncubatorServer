...
namespace Sefate.Incubator.WorkItem.Requrements.BLL
{
    ...
    public class RequirementManager
    {
        ...
        public IncubationRequirement GetIncubationRequirement(int workItemID)
        {
            ...
            foreach (var quardrant in quardrants)
            {
                if (quardrant != null)
                {
                    ...
                    quardrantBLL.IncubatorQuardrantID = databaseQuardrant.IncubatorQuardrantID;
                    quardrantBLL.ScoreCard = new ScoreCard() { Value = 10 };
        ...
        public FieldSetGroup BuildFieldSetGroup(IncubatorRequirements.DALL.FieldSetGroup fieldSetGroup, List<Incubator.WorkItem.DAL.WorkItemField> workItemData, int order, bool isEditable, int? quarterID = null, bool isHidden = false, int? workItemID = null)
        {
                ...
                foreach (var fieldSetGroupMap in fieldSetGroupMaps)
                {
                    ...
                    if (fieldSetInMap != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(fieldSetGroupMap.FieldSetOrder))
                            setOrder = Convert.ToInt32(fieldSetGroupMap.FieldSetOrder);

                        var fieldSet = BuildFieldSet(fieldSetInMap, workItemData, setOrder, isEditable, isHidden,quarterID, workItemID);
        ...
        public FieldSet BuildFieldSet(IncubatorRequirements.DALL.FieldSet fieldSet, List<Incubator.WorkItem.DAL.WorkItemField> workItemData, int order, bool editable, bool isHidden, int? quarterID=null, int? workItemID = null)
        {
            ...
            if (fieldSetMaps != null && fieldSetMaps.Any())
            {
                ...
                foreach (var fieldSetMap in fieldSetMaps)
                {
                    ...
                    if (!string.IsNullOrEmpty(fieldSetMap.FieldOrder))
                        fieldOrder = Convert.ToInt32(fieldSetMap.FieldOrder);

                    var field = BuildField(fieldSetMap, workItemData, fieldOrder, editable,quarterID, workItemID);
					if (field != null)
					{
        ...
        public Sefate.Incubator.WorkItem.RequirementsBuilder.WorkItemField BuildField(IncubatorRequirements.DALL.FieldSetMap fieldSetMap, List<Incubator.WorkItem.DAL.WorkItemField> workItemData, int order, bool editable,int? quarterID=null, int? workItemID = null)
        {
            if (fieldSetMap != null)
            {
				...
				result.FieldScore = Convert.ToInt32(fieldSetMap.FieldScore);
                result.IsEditable = editable;
				...
				if (!string.IsNullOrEmpty(fieldSetMap.Length))
					result.FieldValueLength = Convert.ToInt32(fieldSetMap.Length);
                ...
                if (!string.IsNullOrEmpty(fieldSetMap.IsRequired_Code))
                    result.IsRequired = Convert.ToBoolean(Convert.ToInt16(fieldSetMap.IsRequired_Code));
				if (!string.IsNullOrEmpty(fieldSetMap.IsRelated_Code))
					result.IsRelated  = Convert.ToBoolean(Convert.ToInt16(fieldSetMap.IsRelated_Code));
				...
				if (!string.IsNullOrEmpty(fieldSetMap.Field_Code))
                {
                    ...
                    if (clientField != null)
                    {
                        ...
                        {
                            var dataField = GetFieldValueFromDataField(fieldSetMap.Code, workItemData,quarterID,result.IsRelated);
        ...
        public Sefate.Incubator.WorkItem.RequirementsBuilder.WorkItemField GetField(string mapCode,int workitem)
        {
            ...
            if(field!=null)
            {
                return BuildField(field, null, 1, true, workitem);
            }
            return null;
        }
		...
		public DAL.WorkItemField GetFieldValueFromDataField(string mapCode, List<Incubator.WorkItem.DAL.WorkItemField> workItemData,int? quarterID,bool isRelated)
        {
