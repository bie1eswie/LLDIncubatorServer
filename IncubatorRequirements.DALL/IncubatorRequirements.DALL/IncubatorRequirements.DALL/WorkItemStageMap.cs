...
namespace IncubatorRequirements.DALL
{
    ...
    public partial class WorkItemStageMap
    {
        ...
        public string ActionTeam_Code { get; set; }
        public string ActionTeam_Name { get; set; }
        public Nullable<int> ActionTeam_ID { get; set; }
        public string WorkItemStage_Code { get; set; }
        public string WorkItemStage_Name { get; set; }
        public Nullable<int> WorkItemStage_ID { get; set; }
