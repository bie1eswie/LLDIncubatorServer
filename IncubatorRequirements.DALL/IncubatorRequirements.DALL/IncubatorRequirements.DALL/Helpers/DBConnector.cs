...
namespace IncubatorRequirements.DALL.Helpers
{
    public class DBConnector
    {
        public static IncubatorEntities Get<T>(bool noChangeTracking = false)
        {
			...
			entityConnectionStringBuilder.ProviderConnectionString = "data source=localhost;initial catalog=Incubator;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework";
