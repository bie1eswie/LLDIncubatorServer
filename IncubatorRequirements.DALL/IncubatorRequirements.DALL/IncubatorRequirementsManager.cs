...
namespace IncubatorRequirements.DAL
{
    ...
    {
        private IncubatorEntities dataContext = null;
        public IncubatorEntities DataContext
        {
            get
            {
                return dataContext;
        ...
        {
            dataContext = new IncubatorEntities();
        }

        public IncubatorRequirementsManager(IncubatorEntities dataContext)
        {
        ...
        public List<RequirementMap> GetRequirementMapping(string statusCode, string clientTyype)
        {
            ...
            List<RequirementMap> result = new List<DALL.RequirementMap>();
            using (var currentDataContext = DBConnector.Get<IncubatorEntities>())
            {
        ...
        public List<DALL.IncubatorQuardrant> IncubatorQuardrants()
        {
            using (var currentDataContext = DBConnector.Get<IncubatorEntities>())
            {
        ...
        {
            DropdownSet result = new DALL.DropdownSet();
            using (var currentContext = DBConnector.Get<IncubatorEntities>())
            {
        ...
        public List<WorkItemStages> GetWorkItemStages()
        {
            using (var currentContext = DBConnector.Get<IncubatorEntities>())
            {
        ...
        public WorkItemStages GetWorkItemStageByCode(string code)
        {
            using (var currentContext = DBConnector.Get<IncubatorEntities>())
            {
                var fieldSetGroups = from a in currentContext.WorkItemStages
        ...
        public WorkItemStages GetWorkItemStage(string code)
        {
            using (var currentContext = DBConnector.Get<IncubatorEntities>())
            {
                var fieldSetGroups = from a in currentContext.WorkItemStages
