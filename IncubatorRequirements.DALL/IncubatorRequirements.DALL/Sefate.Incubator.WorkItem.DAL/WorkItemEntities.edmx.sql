...
-- --------------------------------------------------
-- Date Created: 08/14/2017 20:34:33
...
CREATE TABLE [dbo].[WorkItemStages] (
    [WorkItemStageID] int  NOT NULL,
    [StageID] int  NULL,
    [WorkItemID] int  NULL
);
GO

-- Creating table 'DocumentReviewStatuses'
CREATE TABLE [dbo].[DocumentReviewStatuses] (
    [DocumentReviewStatusID] int  NOT NULL,
...
-- Creating table 'WorkItemDocumentStatuses'
CREATE TABLE [dbo].[WorkItemDocumentStatuses] (
    [WorkItemDocumentStatusID] int  NOT NULL,
    [WorkItemID] int  NULL,
    [StatusID] int  NULL,
    [StageID] int  NULL
);
...
CREATE TABLE [dbo].[IncubatorQuardrants] (
    [IncubatorQuardrantID] int  NOT NULL,
...
-- Creating primary key on [DocumentStatusID] in table 'DocumentStatuses'
...
-- Creating primary key on [DocumentReviewStatusID] in table 'DocumentReviewStatuses'
ALTER TABLE [dbo].[DocumentReviewStatuses]
ADD CONSTRAINT [PK_DocumentReviewStatuses]
    PRIMARY KEY CLUSTERED ([DocumentReviewStatusID] ASC);
GO
...
-- Creating primary key on [WorkItemDocumentStatusID] in table 'WorkItemDocumentStatuses'
ALTER TABLE [dbo].[WorkItemDocumentStatuses]
ADD CONSTRAINT [PK_WorkItemDocumentStatuses]
    PRIMARY KEY CLUSTERED ([WorkItemDocumentStatusID] ASC);
GO
