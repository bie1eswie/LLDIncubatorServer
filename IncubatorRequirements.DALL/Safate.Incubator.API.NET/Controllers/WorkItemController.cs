	...
	public class WorkItemController : Controller
	{
		...
		public IActionResult UpdateStatus([FromBody] StageUpdateView model)
		{
			...
			try
			{
				...
				if (result)
				{
					var item = new Sefate.Incubator.WorkItem.WorkItem(model.WorkItem.WorkItemID, 0);
		...
		public IActionResult WorkItems()
		{
			...
			catch(Exception ex)
			{
                ...
                {
                    _requiremtsResult.Message += "Inner Exception : " + ex.InnerException.Message;
                }

                _requiremtsResult.Message += "Stack Trace : " + ex.StackTrace;
