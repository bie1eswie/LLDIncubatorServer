...
namespace NotificationManager
{
    ...
    <tr>
                                                     ...
                                                     <tr>
                                                      ...
                                                      <tr>
                                                          <td style = ""padding: 0 0 20px;text-align: center;"" >
                                                               ...
                                                               <a href = ""https://lldincubatorweb.azurewebsites.net/#/confirmaccount"" style = ""text-decoration: none;color: #FFF;background-color: #1ab394;border: solid #1ab394;border-width: 5px 10px;line-height: 2;font-weight: bold;text-align: center;cursor: pointer;display: inline-block;border-radius: 5px;text-transform: capitalize;"" > Continue with Registration </ a >
        ...
        public static void SendSatusUpdateEmail(string userEmail, string fromStatus, string toStatus, string clientname)
        {
			...
			{
				msg = "Please note that MyGrowthFund is in the process of reviewing your application. Your application has now progressed from {0} to {1}. Please access your profile and continue with the client onboarding.";
    ...
    <tr>
        ...
        <td style = ""display: block !important;max-width: 600px !important;margin: 0 auto !important; clear: both !important;"" width = ""600"" >
            ...
            SendMail(userEmail, body, true, "Password Update");
        }
		...
		public static void SendNewUserEmail(string userEmail, string clientname, string username, string password)
		{
                                               ...
                                               <tr>              
                                                ...
                                                <tr>
                                                     ...
                                                     <tr>
														<td style=""padding: 0 0 20px;"">
															Hi {0} <br>
                                                            This email is to confirm that you have been granted access the LLD Incubator System<br>
															The following is your  login details bellow
															<h4>Username</h4>
															<strong>{1}</strong><br>
															 <h4>Password</h4><br>
															<strong>{2}</strong><br>
                                                            You can always change your password to suit you.
													   </td>
                                                     ...
                                                     ";
			body = string.Format(body, clientname, username, password);
